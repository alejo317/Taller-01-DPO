...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar nombre del país al cual representa un atleta\n");
	...
	private void ejecutarPaisPorAtleta()
	{
		...
		String atleta1 = input("Por favor ingrese el nombre de un atleta");
		String pais = calculadora.buscarPaisPorAtleta(atleta1);
